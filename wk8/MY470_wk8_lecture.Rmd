...
* Assistant Professor of Computational Social Science at LSE Methodology
    - Previously Prof. at University of Southern California
...
* My research:
    ...
    - Text as data methods, social network analysis
    - Author of R packages to analyze data from social media
* Contact: P.Barbera@lse.ac.uk
    - Office hours: Fridays 12.30-14.30
